...
function typeAhead(search) {
  ...
  searchInput.on('input', function () {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default().get("/api/search?q=".concat(this.value)).then(function (res) {
      ...
      searchResults.innerHTML = dompurify__WEBPACK_IMPORTED_MODULE_1___default().sanitize("<div class=\"search__result\">No results for ".concat(_this.value, "</div>"));
    }).catch(function (err) {
      console.error(err);
    });
  }); //======================================================
...
/* harmony import */ var _modules_heart__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/heart */ "./public/javascripts/modules/heart.js");
...
(0,_modules_typeAhead__WEBPACK_IMPORTED_MODULE_3__["default"])((0,_modules_bling__WEBPACK_IMPORTED_MODULE_2__.$)('.search'));
var heartForms = (0,_modules_bling__WEBPACK_IMPORTED_MODULE_2__.$$)('form.heart');
heartForms.on('submit', _modules_heart__WEBPACK_IMPORTED_MODULE_1__["default"]);
}();
/******/ })()
;
